...
This Terraform module deploys a Virtual Network in Azure with subnets, routes and network security group required for Virtual appliance deployment.
...
| <a name="input_location"></a> [location](#input\_location) | Location of the resources that will be deployed. | `string` | `"eastus"` | no |
