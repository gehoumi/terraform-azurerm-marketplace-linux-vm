...
module "Arista-sdwan-edge" {
  ...
  additional_network_security_groups = {
    "VELO_vVCE_SG" = {
      name        = "VELO_vVCE_SG"
      description = "Security Group for Arista SD-WAN Edge"
      rules = {
        "Allow-SSH" = {
          source_address_prefixes      = ["0.0.0.0/0"]
          description                  = "Allow SSH access to the Arista SD-WAN Edge"
          priority                     = 100
          direction                    = "Inbound"
          access                       = "Allow"
          protocol                     = "Tcp"
        ...
        "Allow-UDP-2426" = {
          name                         = "Allow-UDP-2426"
          description                  = "Allow UDP 2426 for Arista Multipath Protocol"
          priority                     = 101
          direction                    = "Inbound"
          access                       = "Allow"
          protocol                     = "Udp"
        ...
        "Allow-SNMP" = {
          name                         = "Allow-SNMP"
          description                  = "Allow SNMP access to the Arista SD-WAN Edge"
          priority                     = 102
          direction                    = "Inbound"
          access                       = "Allow"
          protocol                     = "Udp"
